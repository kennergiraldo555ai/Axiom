...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-[var(--r-md)] text-[13px] font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--c-accent)] disabled:pointer-events-none disabled:opacity-50 ring-offset-2 ring-offset-[var(--c-bg-base)] active:scale-[0.95]",
  {
    variants: {
      variant: {
        default:
          "bg-[var(--c-accent)] text-white hover:bg-[var(--c-accent-hover)] shadow-md shadow-[var(--c-accent-subtle)] font-semibold hover:shadow-[var(--c-accent-border)]",
        destructive:
